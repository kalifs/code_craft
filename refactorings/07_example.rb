...
class TextPrinter
  ...
  def print(color_code)
    ...
    puts border
    puts "\e[#{color_code}mTitle:\e[0m\t\t#{@person.title}"
    puts "\e[#{color_code}mName:\e[0m\t\t#{@person.name}"
    puts "\e[#{color_code}mLast name:\e[0m\t#{@person.last_name}"
    puts "\e[#{color_code}mHouse number:\e[0m\t#{@person.house_number}"
    puts "\e[#{color_code}mStreet:\e[0m\t\t#{@person.street}"
    puts "\e[#{color_code}mTown:\e[0m\t\t#{@person.town}"
    puts "\e[#{color_code}mPostcode:\e[0m\t#{@person.postcode}"
    # prints as many '=' chars as there are in longest attribute plus 16 for two tabs
    puts border
  end
end
