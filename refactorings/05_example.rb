...
class PersonPrinter
  ...
  def print_text(color_code)
    text_printer = TextPrinter.new(@person.name, @person.last_name, @person.house_number, @person.street, @person.town, @person.postcode)
    text_printer.print(color_code)
  end

  def print_json(color_code)
    json_printer = JSONPrinter.new(@person.name, @person.last_name, @person.house_number, @person.street, @person.town, @person.postcode)
    json_printer.print(color_code)
  end

  def print_html(color_code)
    html_printer = HTMLPrinter.new(@person.name, @person.last_name, @person.house_number, @person.street, @person.town, @person.postcode)
